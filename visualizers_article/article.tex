...
\acmConference[Cloud computing e infraestructura para Big Data]{Make sure to enter the correct
  conference title from your rights confirmation emai}{Septiembre 03-09,
...
\title{Visualizers: QuickSight vs. Power BI vs. Looker Studio}
...
\input{docs/2_visualizers.tex}
\input{docs/3_power_bi.tex}
\input{docs/4_aws_quicksight.tex}
\input{docs/5_looker_studio.tex}
\input{docs/6_benchmark.tex}
\input{docs/7_conclucion.tex}
