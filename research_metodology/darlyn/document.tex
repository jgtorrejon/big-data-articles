...
% Incluir la portada
\include{docs/portada.tex} % Reemplaza con \include{portada} si prefieres que se trate como una sección independiente
...
\input{docs/antecedentes.tex}
\input{docs/problematicas.tex}
\input{docs/justificacion.tex}
\input{docs/objetivos.tex}
\input{docs/delimitacion.tex}
