...
% Incluir la portada
\include{docs/front.tex} % Reemplaza con \include{portada} si prefieres que se trate como una sección independiente
...
\input{docs/background.tex}
\input{docs/problem.tex}
\input{docs/justification.tex}
\input{docs/goals.tex}
\input{docs/scope.tex}
