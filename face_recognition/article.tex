...
\title{PROYECTO FINAL: Módulo: MLOPs y Puesta en Producción}
...
\input{docs/2_datos.tex}
\input{docs/3_metodos.tex}
\input{docs/4_despliegue.tex}
\input{docs/5_pipeline.tex}
% \newpage
